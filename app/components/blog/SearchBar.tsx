...
// This component provides a search bar for users to search articles by keywords.
// It uses Next.js's useRouter for navigation and manages the search query state.